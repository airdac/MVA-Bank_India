...
plot(Psi[,eje1],Psi[,eje2],type="n", xlim = c(0,1), ylim = c(-1, 1),
     xlab = "Economical stability", ylab='# Family members', main =
...
eje1 <- 1
eje2 <- 2
plot(Psi[,eje1],Psi[,eje2], xlab= "Economical stability", ylab = "# Family members", main = "Outliers")
axis(side=1, pos= 0, labels = F, col="cyan")
axis(side=3, pos= 0, labels = F, col="cyan")
axis(side=2, pos= 0, labels = F, col="cyan")
axis(side=4, pos= 0, labels = F, col="cyan")
...
plot(df_clean, type = "p", main = "Data without outliers", xlab = "Economical stability", ylab = "# Family members")
# text(Psi[,eje1],Psi[,eje2],labels=iden,  cex=0.5)
axis(side=1, pos= 0, labels = F, col="cyan")
axis(side=3, pos= 0, labels = F, col="cyan")
axis(side=2, pos= 0, labels = F, col="cyan")
